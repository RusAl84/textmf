...
public class Compare {
    ...
    /**
     *
     * For getting Compare object just call this method
     * EXAMPLE:
     * Compare compare = Compare.getInstance();
     *
    ...
    public double symbolDistanceBetweenWords(String word1, String word2){
        ...
        Map<Character, Integer> symbolsWord1 = new HashMap<Character, Integer>();
        Map<Character, Integer> symbolsWord2 = new HashMap<Character, Integer>();
     ...
     * new Compare.longestSubstring(word1, word2); // will return "bb";
     *
     * NOTE:
     ...
     * new Compare.longestSubstring(str1, str2); // will return "bb";
     *
     * NOTE:
    ...
    private String getLeftString(String str1, String str2){
        ...
        if (strings.length == 0)
            ...
            return new String(strings[0].intern());
    }
    ...
    private String getRightString(String str1, String str2){
        ...
        return new String(all[1].intern());
    }
    ...
    private static class SingeltonHolder{
        ...
        protected static final Compare SINGELTON = new Compare();
